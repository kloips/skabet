...
----------------------------------------------------------------*/
const files = {
  "outerwear-3.png":  { navn: "Ternet flannelskjorte, grå og hvid", paenhed: 4, farve: "hvid", farve2: "graa", moenster: "ternet" },

  "outerwear-4.png":  { navn: "Mørkeblå fløjlsovershirt", paenhed: 4, farve: "navy", moenster: "ensfarvet" },

  "outerwear-5.png":  { navn: "Olivengrøn overshirt med brystlommer", paenhed: 4, farve: "oliven", moenster: "ensfarvet" },

  "outerwear-6.png":  { navn: "Grå vindjakke med hætte", paenhed: 2, farve: "graa", moenster: "ensfarvet" },
  "outerwear-7.png":  { navn: "Sort vinterjakke", paenhed: 1, farve: "sort", moenster: "ensfarvet" },
  "outerwear-8.png":  { navn: "Sort lynlåsjakke med krave", paenhed: 4, farve: "sort", moenster: "ensfarvet" },
  "outerwear-9.png":  { navn: "Brun overshirt med trykknapper", paenhed: 4, farve: "brun", moenster: "ensfarvet" },
  "outerwear-10.png": { navn: "Lysegrå vindjakke med hætte", paenhed: 2, farve: "graa", moenster: "ensfarvet" },
  "outerwear-11.png": { navn: "Mørkebrun vest ", paenhed: 3, farve: "brun", moenster: "ensfarvet" },
  "outerwear-12.png": { navn: "Brun jakke med hvide syninger", paenhed: 2, farve: "brun", moenster: "ensfarvet" },
  "outerwear-13.png": { navn: "Grå jakke med krave", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "outerwear-14.png": { navn: "Sort lang frakke", regn: true, paenhed: 5, farve: "sort", moenster: "ensfarvet" },
  "outerwear-15.png": { navn: "Grøn jakke med hætte og klaplommer", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "outerwear-16.png": { navn: "Lyseblå denimskjortejakke", paenhed: 4, farve: "blaa", moenster: "ensfarvet" },
  "outerwear-17.png": { navn: "Sort regnjakke med hætte", regn: true, paenhed: 2, farve: "sort", moenster: "ensfarvet" },

  "mid-3.png":  { navn: "Sort sweatshirt", paenhed: 4, farve: "sort", moenster: "print" },
  "mid-4.png":  { navn: "Lysegrå hoodie med lynlås", paenhed: 2, farve: "graa", moenster: "ensfarvet" },
  "mid-5.png":  { navn: "Grå hoodie", paenhed: 1, farve: "graa", moenster: "ensfarvet" },
  "mid-6.png":  { navn: "Navy GAP hoodie med lynlås", paenhed: 2, farve: "navy", moenster: "print" },
  "mid-7.png":  { navn: "Lysegrå BLS hoodie", paenhed: 1, farve: "graa", moenster: "print" },
  "mid-8.png":  { navn: "Grøn hoodie med lynlås", paenhed: 2, farve: "groen", moenster: "ensfarvet" },
  "mid-9.png":  { navn: "Grøn sweatshirt", paenhed: 3, farve: "oliven", moenster: "ensfarvet" },
  "mid-10.png": { navn: "Mørkegrøn strik", paenhed: 4, farve: "sort", moenster: "ensfarvet" },
  "mid-11.png": { navn: "Gråblå strik", paenhed: 4, farve: "graa", farve2: "blaa", moenster: "ensfarvet" },
  "mid-12.png": { navn: "Lysegrå strik", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "mid-13.png": { navn: "Grøn sweatshirt", paenhed: 4, farve: "brun", moenster: "ensfarvet" },
  "mid-14.png": { navn: "Mørkeblå zip sweatshirt", paenhed: 4, farve: "navy", moenster: "ensfarvet" },
  "mid-15.png": { navn: "Brun strik", paenhed: 3, farve: "brun", moenster: "ensfarvet" },
  "mid-16.png": { navn: "Navy Pull&Bear sweatshirt", paenhed: 2, farve: "navy", moenster: "print" },
  "mid-17.png": { navn: "Sort sweatshirt", paenhed: 3, farve: "sort", moenster: "ensfarvet" },
  "mid-18.png": { navn: "HK grå sweatshirt", paenhed: 1, farve: "sort", moenster: "print" },
  "mid-19.png": { navn: "Grøn HK sweatshirt", paenhed: 3, farve: "oliven", moenster: "ensfarvet" },
  "mid-20.png": { navn: "Lysegrå sweatshirt", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "mid-21.png": { navn: "Grå strik", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "mid-22.png": { navn: "Mørkegrå strik", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "mid-23.png": { navn: "Lysegrå zip sweatshirt", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "mid-24.png": { navn: "Mørkeblå ternet skjorte", paenhed: 3, farve: "navy", moenster: "ternet" },
  "mid-25.png": { navn: "Ternet skjorte, hvid og blå", paenhed: 3, farve: "creme", farve2: "sort", moenster: "ternet" },
  "mid-26.png": { navn: "Blå fin skjorte", paenhed: 4, farve: "blaa", farve2: "hvid", moenster: "ternet" },
  "mid-27.png": { navn: "Ternet kort skjorte", paenhed: 3, farve: "beige", moenster: "ternet" },
  "mid-28.png": { navn: "Lyseblå ternet skjorte", paenhed: 3, farve: "creme", farve2: "blaa", moenster: "ternet" },
  "mid-29.png": { navn: "Grøn og hvid ternet skjorte", paenhed: 3, farve: "groen", farve2: "creme", moenster: "ternet" },
  "mid-30.png": { navn: "Blå skjorte", paenhed: 4, farve: "blaa", moenster: "ensfarvet" },
  "mid-31.png": { navn: "Ternet blå flannelskjorte", paenhed: 3, farve: "navy", moenster: "ternet" },
  "mid-32.png": { navn: "Mørkeblå flannelskjorte", paenhed: 3, farve: "blaa", moenster: "ensfarvet" },
  "mid-33.png": { navn: "Sort, brun og hvid skjorte", paenhed: 3, farve: "sort", farve2: "creme", moenster: "ternet" },

  "bottom-4.png":  { navn: "Sorte jeans", paenhed: 2, farve: "sort", moenster: "ensfarvet" },
  "bottom-5.png":  { navn: "Brune habitbukser", paenhed: 5, farve: "brun", moenster: "ensfarvet" },
  "bottom-6.png":  { navn: "Mørkeblå jeans", paenhed: 4, farve: "navy", moenster: "ensfarvet" },
  "bottom-8.png":  { navn: "Creme jeans", paenhed: 2, farve: "creme", moenster: "ensfarvet" },
  "bottom-9.png":  { navn: "Grå jeans", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "bottom-10.png": { navn: "Brungrå jeans", paenhed: 1, farve: "graa", farve2: "brun", moenster: "ensfarvet" },
  "bottom-11.png": { navn: "Blå jeans", paenhed: 4, farve: "blaa", moenster: "ensfarvet" },
  "bottom-12.png": { navn: "Koksgrå jeans", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "bottom-13.png": { navn: "Sorte bukser, smalle", paenhed: 5, farve: "sort", moenster: "ensfarvet" },
  "bottom-14.png": { navn: "Sorte bukser, brede", paenhed: 5, farve: "sort", moenster: "ensfarvet" },
  "bottom-15.png": { navn: "Lysegrå bukser", paenhed: 2, farve: "graa", moenster: "ensfarvet" },
  "bottom-16.png": { navn: "Lyseblå jeans", paenhed: 1, farve: "blaa", moenster: "ensfarvet" },
  "bottom-18.png": { navn: "Støvet blå jeans", paenhed: 3, farve: "blaa", moenster: "ensfarvet" },

  "shorts-1.png":  {navn: "Mørke denimshorts", paenhed: 3, farve: "navy", moenster: "ensfarvet" },
  "shorts-2.png":  {navn: "Sorte denimshorts", paenhed: 3, farve: "sort", moenster: "ensfarvet" },
  "shorts-3.png":  {navn: "Grå denimshorts", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "shorts-4.png":  {navn: "Lyseblå denimshorts", paenhed: 3, farve: "blaa", moenster: "ensfarvet" },
  "shoes-3.png":  { navn: "Hvide Nike Cortez", paenhed: 2, farve: "hvid", moenster: "ensfarvet" },
  "shoes-4.png":  { navn: "Asics navy og grå", paenhed: 3, farve: "graa", farve2: "blaa", moenster: "ensfarvet" },
  "shoes-5.png":  { navn: "Asics Gel-Lyte III, blå og grå", paenhed: 3, farve: "navy", farve2: "graa", moenster: "ensfarvet" },
  "shoes-6.png":  { navn: "Adidas Stan Smith, hvid og grøn", paenhed: 4, farve: "hvid", moenster: "ensfarvet" },
  "shoes-7.png":  { navn: "Sorte nike", paenhed: 2, farve: "sort", moenster: "ensfarvet" },
  "shoes-8.png":  { navn: "Loafers brede", paenhed: 5, farve: "sort", moenster: "ensfarvet" },
  "shoes-9.png":  { navn: "Brune loafers", paenhed: 5, farve: "sort", moenster: "ensfarvet" },
  "shoes-10.png": { navn: "Adidas Spezials", paenhed: 2, farve: "sort", moenster: "ensfarvet" },
  "shoes-11.png": { navn: "Adidas superstar", paenhed: 3, farve: "hvid", moenster: "ensfarvet" },
  "shoes-12.png": { navn: "Clarks", paenhed: 5, farve: "graa", moenster: "ensfarvet" },
  "shoes-13.png": { navn: "Grå Ascics", paenhed: 4, farve: "graa", moenster: "ensfarvet" },
  "shoes-14.png": { navn: "Adidas Gazelle Indoor, grøn", paenhed: 4, farve: "groen", moenster: "ensfarvet" },
  "shoes-15.png": { navn: "P6000 hvide", paenhed: 3, farve: "hvid", moenster: "ensfarvet" },
  "shoes-16.png": { navn: "brune adidas", paenhed: 4, farve: "brun", moenster: "ensfarvet" },
  "shoes-17.png": { navn: "Converse grønne", paenhed: 3, farve: "oliven", moenster: "ensfarvet" },
  "shoes-18.png": { navn: "Timberland bådsko, brune", paenhed: 3, farve: "brun", moenster: "ensfarvet" },

  "top-4.png":  { navn: "Grå t-shirt", paenhed: 3, farve: "beige", moenster: "ensfarvet" },
  "top-5.png":  { navn: "Lysegrå t-shirt", paenhed: 3, farve: "creme", moenster: "ensfarvet" },
  "top-6.png":  { navn: "Grøn t-shirt med logo", paenhed: 2, farve: "oliven", moenster: "ensfarvet" },
  "top-7.png":  { navn: "Sort t-shirt", paenhed: 4, farve: "sort", moenster: "ensfarvet" },
  "top-8.png":  { navn: "Sort t-shirt (Carhartt tekst)", paenhed: 2, farve: "sort", moenster: "print" },
  "top-9.png":  { navn: "Sort t-shirt med print", paenhed: 1, farve: "sort", moenster: "print" },
  "top-10.png": { navn: "Mørkeblå t-shirt (Carhartt logo)", paenhed: 2, farve: "navy", moenster: "ensfarvet" },
  "top-11.png": { navn: "Lyseblå stribet polo med lynlås", paenhed: 4, farve: "blaa", farve2: "hvid", moenster: "stribet" },
  "top-12.png": { navn: "Sort/gul stribet t-shirt med print", paenhed: 1, farve: "creme", farve2: "navy", moenster: "stribet" },
  "top-13.png": { navn: "Grøn polo", paenhed: 4, farve: "groen", moenster: "ensfarvet" },
  "top-14.png": { navn: "Mørkeblå t-shirt", paenhed: 4, farve: "navy", moenster: "ensfarvet" },
  "top-15.png": { navn: "Grå t-shirt med print", paenhed: 2, farve: "graa", moenster: "print" },
  "top-16.png": { navn: "Grå t-shirt (Good Life)", paenhed: 2, farve: "graa", moenster: "print" },
  "top-17.png": { navn: "Olivengrøn t-shirt med hvid kant", paenhed: 4, farve: "oliven", moenster: "ensfarvet" },
  "top-18.png": { navn: "Grøn t-shirt med print", paenhed: 1, farve: "groen", moenster: "ensfarvet" },
  "top-19.png": { navn: "Sort t-shirt med japansk print", paenhed: 2, farve: "sort", moenster: "print" },
  "top-20.png": { navn: "Olivengrøn polo med lynlås", paenhed: 5, farve: "beige", moenster: "ensfarvet" },
  "top-21.png": { navn: "Petrol t-shirt (Nike Moving Co)", paenhed: 1, farve: "petrol", moenster: "print" },
  "top-22.png": { navn: "Sort t-shirt (Arigato)", paenhed: 3, farve: "sort", moenster: "print" },
  "top-23.png": { navn: "Brun strikpolo", paenhed: 5, farve: "brun", moenster: "ensfarvet" },
  "top-24.png": { navn: "Sort langærmet t-shirt", paenhed: 2, farve: "sort", moenster: "ensfarvet" },
  "top-25.png": { navn: "Grøn stribet langærmet polo", paenhed: 3, farve: "groen", farve2: "hvid", moenster: "stribet" },
  "top-26.png": { navn: "Grøn stribet langærmet t-shirt", paenhed: 3, farve: "oliven", moenster: "stribet" },
  "top-27.png": { navn: "Hvid langærmet t-shirt", paenhed: 3, farve: "creme", moenster: "ensfarvet" },
  "top-28.png": { navn: "Mørkegrå langærmet t-shirt", paenhed: 2, farve: "graa", moenster: "ensfarvet" },
  "top-29.png": { navn: "Lysegrå langærmet t-shirt", paenhed: 3, farve: "graa", moenster: "ensfarvet" },
  "top-30.png": { navn: "Sort/hvid stribet t-shirt", paenhed: 4, farve: "hvid", farve2: "sort", moenster: "stribet" },
  "top-31.png": { navn: "Hvid stribet t-shirt", paenhed: 5, farve: "creme", moenster: "ensfarvet" },
  "top-32.png": { navn: "Creme strikpolo", paenhed: 5, farve: "creme", moenster: "ensfarvet" },
  "top-33.png": { navn: "Hvid t-shirt med bølge-print", paenhed: 2, farve: "hvid", moenster: "print" },
  "top-34.png": { navn: "Hvid t-shirt (YourTurn)", paenhed: 3, farve: "hvid", moenster: "ensfarvet" },
  "top-35.png": { navn: "Hvid t-shirt", paenhed: 4, farve: "hvid", moenster: "ensfarvet" },
  "top-36.png": { navn: "Hvid t-shirt", paenhed: 4, farve: "hvid", moenster: "ensfarvet" },
  "top-37.png": { navn: "Creme t-shirt med grønt print", paenhed: 3, farve: "creme", moenster: "print" },
  "top-38.png": { navn: "Hvid t-shirt", paenhed: 2, farve: "hvid", moenster: "ensfarvet" },
  "top-39.png": { navn: "Sort t-shirt", paenhed: 4, farve: "sort", moenster: "ensfarvet" },
  "top-40.png": { navn: "Blå t-shirt", paenhed: 4, farve: "blaa", moenster: "ensfarvet" },
  "top-41.png": { navn: "Grå t-shirt med print (Deus Customs)", paenhed: 2, farve: "graa", moenster: "print" },
  "top-42.png": { navn: "Blå/hvid stribet langærmet t-shirt", paenhed: 3, farve: "hvid", farve2: "blaa", moenster: "stribet" },
  "top-43.png": { navn: "Turkis/hvid stribet langærmet t-shirt", paenhed: 2, farve: "turkis", farve2: "hvid", moenster: "stribet" }
};
